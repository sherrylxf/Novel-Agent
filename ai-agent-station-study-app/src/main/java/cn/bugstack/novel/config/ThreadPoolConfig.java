...
public class ThreadPoolConfig {
    ...
    public ThreadPoolExecutor threadPoolExecutor(ThreadPoolConfigProperties properties) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        ThreadPoolExecutor executor = new ThreadPoolExecutor(properties.getCorePoolSize(),
                ...
                handler);
        log.info("线程池配置完成：corePoolSize={}, maxPoolSize={}, keepAliveTime={}, blockQueueSize={}, policy={}",
                properties.getCorePoolSize(), properties.getMaxPoolSize(), 
                properties.getKeepAliveTime(), properties.getBlockQueueSize(), properties.getPolicy());
        return executor;
    }
